...
// This object holds holds composition specific state and bindings specific to
// composition on Fuchsia.
class CompositorContext final : public flutter::CompositorContext {
 public:
  CompositorContext(std::shared_ptr<SessionConnection> session_connection);
