...
DefaultSessionConnection::DefaultSessionConnection(
    ...
    : session_wrapper_(session.Bind(), nullptr),
      ...
      frames_requested_(inspect_node_.CreateUint("FramesRequested", 0u)),
      frames_presented_(inspect_node_.CreateUint("FramesPresented", 0u)),
      frames_completed_(inspect_node_.CreateUint("FramesCompleted", 0u)),
      ...
      last_frame_requested_(inspect_node_.CreateInt("LastFrameRequestTime", 0)),
      last_frame_presented_(inspect_node_.CreateInt("LastFramePresentTime", 0)),
      last_frame_completed_(
          inspect_node_.CreateInt("LastFrameCompleteTime", 0)),
        ...
        async::PostTask(
            ...
            [this, num_presents_handled,
             now = fml::TimePoint::Now().ToEpochDelta().ToNanoseconds()]() {
              frames_completed_.Add(num_presents_handled);
